module DotNetLightning.Serialize.NetworkSerializer
...
let Serialze (output: #Stream) (s: LightningMsg) =
    ...
    | (AcceptChannel msg) ->
        ...
        w.Write(msg.TemporaryChannelId.Value.ToBytes())
        w.Write(msg.DustLimitSatoshis.Satoshi)
        w.Write(msg.MaxHTLCValueInFlightMsat)
        w.Write(msg.ChannelReserveSatoshis)
        w.Write(msg.HTLCMinimumMSat)
    ...
    | (ChannelReestablish msg) ->
        ...
        w.Write(msg.NextRemoteRevocationNumber)
