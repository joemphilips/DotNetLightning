[<AutoOpen>]
module internal DotNetLightning.Infrastructure.Common
...
let internal getDefaultDataDirectory(appDirectory: string, subDirectory: string, createIfNotExists: bool option) =
