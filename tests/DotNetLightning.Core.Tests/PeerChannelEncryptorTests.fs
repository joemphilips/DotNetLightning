        ...
        |> fun c ->
            let expectedIE =
                ...
                | InProgress inProgressNoiseState ->
                    ...
                    | OutBound outbound -> Some outbound.IE
                    | _ -> None
                | _ -> None
...
let peerChannelEncryptorTests =
    testList
        "PeerChannelEncryptorTests"
        [
            testCase "noise initiator test vectors"
            <| fun _ ->
                let ourNodeId =
                    new Key(
                        hex.DecodeData(
                ...
                let testCase1() =
                    ...
                    let res =
                        outboundPeer
                        |> PeerChannelEncryptor.processActTwo actTwo ourNodeId
                ...
                let testCase2() =
                    ...
                    Expect.throws
                        (fun _ ->
                            outboundPeer
                            |> PeerChannelEncryptor.processActTwo
                                actTwo
                                ourNodeId
                            |> ignore
                        )
            ...
            testCase "noise responder test vectors"
            <| fun _ ->
                let ourNodeSecret =
                    hex.DecodeData(
                ...
                let _testCase1 =
                    let inboundPeer1 =
                        ourNodeSecret |> PeerChannelEncryptor.newInBound
                    ...
                    let actualRR =
                        inboundPeer2
                        |> PeerChannelEncryptor.processActThree(actThree)
                ...
                let _testCase2 =
                    let inboundPeer =
                        PeerChannelEncryptor.newInBound(ourNodeSecret)
                    ...
                    Expect.throwsT<System.ArgumentException>
                        (fun _ ->
                            PeerChannelEncryptor.processActOneWithKey
                                actOne
                                ourNodeSecret
                                inboundPeer
                            |> ignore
                ...
                let _testCase8 =
                    ...
                    let expectedActOneResult =
                        hex.DecodeData(
                            "0002466d7fcae563e5cb09a0d1870bb580344804617879a14949cf22285f1bae3f276e2470b93aac583c9ef6eafca3f730ae"
                        )

                    let actualActOneResult, inboundPeer2 =
                        inboundPeer
                        |> PeerChannelEncryptor.processActOneWithEphemeralKey
                            actOne
                            ourNodeSecret
                    ...
                    let r =
                        PeerChannelEncryptor.processActThree
                            actThree
                            inboundPeer2
            ...
            testCase "message encryption decryption test vectors"
            <| fun _ ->
                let mutable outboundPeer =
                    getOutBoundPeerForInitiatorTestVectors()
                ...
                let _testCase1 =
                    ...
                    let (actualActTwoResult, _), outboundPeer2 =
                        outboundPeer
                        |> PeerChannelEncryptor.processActTwo actTwo ourNodeId
                        |> Result.deref

                    let expectedActTwoResult =
                        "00b9e3a702e93e3a9948c2ed6e5fd7590a6e1c3a0344cfc9d5b57357049aa22355361aa02e55a8fc28fef5bd6d71ad0c38228dc68b1c466263b47fdf31e560e139ba"
                        |> hex.DecodeData
                    ...
                    | _ ->
                        failwith "Fail: outboundPeer2.NoiseState not Finished"
                ...
                let mutable inboundPeer =
                    PeerChannelEncryptor.newInBound ourNodeId
                ...
                let _testCase2 =
                    ...
                    let expectedActThreeResult =
                        "034f355bdcb7cc0af728ef3cceb9615d90684bb5b2ca5f859ab0f0b704075871aa"
                        |> hex.DecodeData
                        |> PubKey
                        |> NodeId

                    let actualActThreeResult, inboundPeer3 =
                        PeerChannelEncryptor.processActThree
                            (actThree)
                            inboundPeer2
                        |> Result.deref
                ...
                let rec loop (i: int) localOutBound localInbound =
                    ...
                    if i > 1005 then
                        ...
                        let res, newOutBound =
                            let instruction =
                                noise { return! encryptMessage msg }
                        ...
                        let actualLengthR =
                            let instruction =
                                noise {
                                    let! header =
                                        decryptLengthHeader(lengthHeader)
                        ...
                        let actualLength, inbound2 =
                            actualLengthR |> Result.deref
