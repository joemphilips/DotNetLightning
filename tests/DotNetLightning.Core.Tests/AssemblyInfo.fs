...
[<assembly: AssemblyTitleAttribute("DotNetLightning.Tests")>]
...
[<assembly: UserSecretsIdAttribute("")>]
do ()

module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "DotNetLightning.Tests"
    let [<Literal>] AssemblyProduct = "DotNetLightning"
